...
~~~
Problem Statement:
Design and implement a predictive system using Random Forest to estimate air quality (PM2.5), ambient temperature, and energy usage from real-time IoT sensor data. The system aims to assist in pollution control, climate monitoring, and efficient energy management in smart city environments.

The dataset “weather-station-eee-block_2024_07_13.csv” contains real-time environmental sensor readings such as temperature, humidity, and atmospheric conditions collected from a weather station. It is used to analyze environmental patterns and to train a Random Forest model for predicting temperature, air quality (PM2.5), and energy-related parameters.
~~~
...
## Output:
<img width="1120" height="930" alt="image" src="https://github.com/user-attachments/assets/c23ab997-cffd-4c3e-b8ef-3404dea24724" />

<img width="1129" height="800" alt="image" src="https://github.com/user-attachments/assets/d21cd58c-c8a9-4599-a9c2-0c291056188a" />
